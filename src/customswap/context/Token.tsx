...
const FnTokenContext = React.createContext<TokenContext | null>(null);
...
function useTokenContext() {
  const ctx = useContext(FnTokenContext);
  if (ctx === null) {
...
export function useOwnedTokenAccount(
  ...
  }, [provider.connection, tokenAccount,isSol,provider.wallet]);
