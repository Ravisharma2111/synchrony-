...
import leaderprofile from '../../assets/img/Profile.png';
    ...
    <div className="TableAcrodSec">
      <div className={classes.root} style={{ paddingTop: 0, }}>
        <div className={classes.firstBuilderbox}>
          <div className={classes.tabinnercontent1} style={{ marginTop: 0, }}>
            <Grid container spacing={6}>
              <Grid item xs={8}>
                <Paper className={classes.paper}>
                  <div className={classes.leader_profile}>
                    <div >
                      <img src={leaderprofile} alt="" />
                    </div>
                    <div className={classes.profileContent} style={{ paddingLeft: 20, paddingRight: 0, }}>
                      ...
                      <div className="lasttrktime">
                        <p>Last TXR time <b>2 Hours</b></p>
                      </div>
                    </div>
                  </div>
                </Paper>
              </Grid>
              <Grid item xs={4} className={classes.portfolio} style={{ marginTop: 0, paddingTop: 0, paddingLeft: 30, paddingBottom: 0, }}>
