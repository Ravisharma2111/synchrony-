...
type MetadataEndpoint = {
	programId: PublicKey, //CONSTANT
	authority: PublicKey,
	metadata: PublicKey, //CONSTANT
	vault: PublicKey, //CONSTANT
	duration: Numberu64,
	apr: Numberu64,
...
type VestingEndpoint = {
	programId: PublicKey, //CONSTANT
	authority: PublicKey,
	tokenAccount: PublicKey,
	vestingAccount: PublicKey, //NOTE: This is generated by a call to another on chain program - DO NOT DO FOR NOW
	vault: PublicKey, //CONSTANT
	metadata: PublicKey, //CONSTANT - 3 choices each button will call a different metadata account (ill provide a map of these accounts).
	tokenProgram: PublicKey, //CONSTANT
	amount: Numberu64,
}
