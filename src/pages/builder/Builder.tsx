...
const BuilderList = (props: RouteComponentProps) => {
   ...
   const handleSubmit = (event: any) => {
      ...
      fetch(API_PATH + 'postdata.php', requestOptions)
               ...
               <div className={classes.tabinnercontent}>
                  ...
                  <form className={classes.root} noValidate autoComplete="off">
                     <Grid container spacing={3}>
                        ...
                        <Grid item xs={6}>
                           <FormControl className={classes.formControl}>
                              ...
                              >
                                 ...
                                 <option value={'Token Set'}>Token Set</option>
                                 <option value={'Yield Farm'}>Yield Farm</option>
                              </NativeSelect>
                           </FormControl>
                        </Grid>
                        <Grid className={classes.managePercentage} item xs={3}>
                           <TextField type="date" label="Evalutaion Timeframe" placeholder="start time" fullWidth InputLabelProps={{ shrink: true, }} onChange={(e) => { setFormData({ ...formData, evaution_st: e.target.value }) }} value={formData.evaution_st} />
                        </Grid>
                        <Grid className={classes.managePercentage} item xs={3}>
                           <TextField type="date" label="&nbsp;" placeholder="end time" fullWidth InputLabelProps={{ shrink: true, }} onChange={(e) => { setFormData({ ...formData, evaution_et: e.target.value }) }} value={formData.evaution_et} />
                        </Grid>
                        <Grid className={classes.managePercentage} item xs={3}>
                        ...
                        <Grid item xs={6}>
                           <TextField onChange={(e) => { setFormData({ ...formData, EvaluationRange: e.target.value }) }} label="Evaluation Range" placeholder="for ex: mcap between 1M and 1B" fullWidth InputLabelProps={{ shrink: true, }} value={formData.EvaluationRange} />
                        </Grid>
                        <Grid item xs={6}>
                  ...
                  <FormControl className={classes.formControl}>
                     ...
                     <option value={30}>Thirty</option>
                        ...
                        {formData.WhitelistedTokens.map((x, i) => {
                           return (
                              <Grid item xs={12} style={{ position: 'relative', }} key={i}>
