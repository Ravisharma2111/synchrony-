...
import {
	Drawer, Tab, Tabs, AppBar, Typography, Box, TextField, InputLabel, Button,
	Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, List, ListItem
				...
				<DialogActions className={classes.listFooter}>
					{(startConverting === false) &&
						<><Typography>Receive <small>5.1643  ETH</small></Typography>
							<Button className={classes.fullPrimarybtn} onClick={startConversion}>Confirm Create</Button>
						</>
					}
